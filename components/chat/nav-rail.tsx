...
export function NavRail({
  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed bottom-0 inset-x-0 h-14 bg-[#f0f2f5]/95 dark:bg-[#202c33]/95 backdrop-blur-md border-t border-border/50 flex items-center justify-around z-40 px-2 select-none">
        <button
          onClick={() => onSelectTab("chats")}
